...
export async function StatsBar() {
  ...
  return (
    <div className="font-[family-name:var(--font-lora)] text-sm text-stone-700 flex flex-wrap gap-x-8 gap-y-1 border-y border-stone-300/60 py-3 my-6" data-testid="stats-bar">
